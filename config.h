...
{
    { 
        0, XK_Caps_Lock,      spawn,    SHCMD("xdotool key Escape") 
    }
...
,   { MODKEY|ControlMask|ShiftMask, XK_r                    , CMD("/usr/bin/remmina")                                                                                                                                                                     }
...
,   { MODKEY|ShiftMask            , XK_d                    , spawn          , CMD("env _JAVA_AWT_WM_NONREPARENTING=1 /opt/DataGrip-2020.2.3/bin/datagrip.sh")                                                                                            }
